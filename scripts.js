...
/*
    function trainingTabInfo() {
      ...
      if (secondDateCheck.toString().includes("Sat")) {
        ...
        secondDate = new Date(
          secondDateCheck.setDate(secondDateCheck.getDate())
        );
      }
      ...
      var thirdDateCheck = new Date(
        secondDate.setDate(secondDate.getDate() + 1)
      );
      if (thirdDateCheck.toString().includes("Sat")) {
        thirdDate = new Date(
          thirdDateCheck.setDate(thirdDateCheck.getDate() + 2)
        );
      } else if (thirdDateCheck.toString().includes("Sun")) {
        thirdDate = new Date(
          thirdDateCheck.setDate(thirdDateCheck.getDate() + 1)
        );
      } else {
      ...
      if (fourthDateCheck.toString().includes("Sat")) {
        ...
        fourthDate = new Date(
          fourthDateCheck.setDate(fourthDateCheck.getDate())
        );
      }
      ...
      if (sixthDateCheck.toString().includes("Sat")) {
        sixthDate = new Date(
          sixthDateCheck.setDate(sixthDateCheck.getDate() + 2)
        );
      } else if (sixthDateCheck.toString().includes("Sun")) {
        sixthDate = new Date(
          sixthDateCheck.setDate(sixthDateCheck.getDate() + 1)
        );
      } else {
      ...
      if (eighthDateCheck.toString().includes("Sat")) {
        ...
        eighthDate = new Date(
          eighthDateCheck.setDate(eighthDateCheck.getDate())
        );
      }
      ...
      var ninthDateCheck = new Date(
        eighthDate.setDate(eighthDate.getDate() + 1)
      );
      if (ninthDateCheck.toString().includes("Sat")) {
        ninthDate = new Date(
          ninthDateCheck.setDate(ninthDateCheck.getDate() + 2)
        );
      } else if (ninthDateCheck.toString().includes("Sun")) {
        ninthDate = new Date(
          ninthDateCheck.setDate(ninthDateCheck.getDate() + 1)
        );
      } else {
      ...
      if (tenthDateCheck.toString().includes("Sat")) {
        tenthDate = new Date(
          tenthDateCheck.setDate(tenthDateCheck.getDate() + 2)
        );
      } else if (tenthDateCheck.toString().includes("Sun")) {
        tenthDate = new Date(
          tenthDateCheck.setDate(tenthDateCheck.getDate() + 1)
        );
      } else {
